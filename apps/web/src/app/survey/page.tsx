        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center space-y-4 mb-6 md:mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-50/50 backdrop-blur-sm border border-cyan-100/20">
              ...
              <span className="text-cyan-600 font-medium text-xs">맞춤형 피부 타입 분석</span>
              <div className="h-px w-4 md:w-6 bg-cyan-500/50"></div>
            </div>
            ...
            <p className="text-xs md:text-sm text-slate-600 max-w-md mx-auto leading-relaxed">
              16가지 과학적 피부 타입과 6가지 핵심 지표로<br className="md:hidden" /> 정확한 피부 분석을 제공합니다.
            ...
            <ul className="space-y-4 md:space-y-8 mb-6">
              <li className="flex gap-3 items-start group">
                ...
                <p className="text-xs md:text-sm text-slate-600 flex-1 leading-relaxed">
                  <span className="font-medium text-slate-800">객관적인 답변</span>을 해주세요. 현재 피부 상태에 대해 있는 그대로 답변해주세요.
                </p>
              </li>
              <li className="flex gap-3 items-start group">
                <div className="w-5 h-5 md:w-8 md:h-8 bg-gradient-to-br from-teal-500 to-cyan-500 text-white rounded-xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-105 shadow-md shadow-teal-500/10 flex-shrink-0 mt-0.5">
                ...
                <p className="text-xs md:text-sm text-slate-600 flex-1 leading-relaxed">
                  <span className="font-medium text-slate-800">맞춤형 피부 타입</span>은 유수분, 민감도, 색소침착, 노화도의 4가지 차원으로 분석합니다.
                </p>
              </li>
              <li className="flex gap-3 items-start group">
                <div className="w-5 h-5 md:w-8 md:h-8 bg-gradient-to-br from-teal-500 to-cyan-500 text-white rounded-xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-105 shadow-md shadow-teal-500/10 flex-shrink-0 mt-0.5">
                ...
                <p className="text-xs md:text-sm text-slate-600 flex-1 leading-relaxed">
                  <span className="font-medium text-slate-800">로그인 없이도</span> 설문 결과를 확인할 수 있습니다. 결과는 90일간 저장됩니다.
                </p>
              </li>
              <li className="flex gap-3 items-start group">
                <div className="w-5 h-5 md:w-8 md:h-8 bg-gradient-to-br from-teal-500 to-cyan-500 text-white rounded-xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-105 shadow-md shadow-teal-500/10 flex-shrink-0 mt-0.5">
                ...
                <p className="text-xs md:text-sm text-slate-600 flex-1 leading-relaxed">
                  <span className="font-medium text-slate-800">언제든지 중단</span>하고 나중에 다시 시작할 수 있습니다.
                </p>
              </li>
            </ul>
          ...
          <div className="text-center">
            <p className="text-slate-500 text-[10px] md:text-xs">
              설문에 참여함으로써 <Link href="/privacy" className="text-cyan-600 hover:text-cyan-700 transition-colors duration-200 underline decoration-cyan-200 underline-offset-4">개인정보처리방침</Link>에 동의하게 됩니다.
            </p>
          </div>
        </div>
      </main>
